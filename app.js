...
const SERIES = {
  journals: {
    ...
    // ссылки для «ленты» внизу (можешь заменить на реальные)
    strip: {
    ...
    books: {
      dad: {
        ...
        img: {
          sm: "assets/covers/dad-small.jpg",
          lg: "assets/covers/dad-large.jpg"
        },
        amazon: {
          pb: "https://www.amazon.com/dp/B0FPF71CQ8"
        },
        pages: [
          "assets/inside/dad-1.jpg",
          "assets/inside/dad-2.jpg"
        ],
        desc: `
<ul>
...
`
      ...
      mom: {
        ...
        subtitle: "a guided memory journal",
        img: {
          sm: "assets/covers/mom-small.jpg",
          lg: "assets/covers/mom-large.jpg"
        },
        amazon: {
          pb: "https://www.amazon.com/dp/B0FPF71CQ8"
        },
...
`
      ...
      grandpa: {
        ...
        subtitle: "a guided memory journal",
        img: {
          sm: "assets/covers/grandpa-small.jpg",
          lg: "assets/covers/grandpa-large.jpg"
        },
        amazon: {
          pb: "https://www.amazon.com/dp/B0FPF71CQ8"
        },
...
`
      ...
      grandma: {
        ...
        subtitle: "a guided memory journal",
        img: {
          sm: "assets/covers/grandma-small.jpg",
          lg: "assets/covers/grandma-large.jpg"
        },
        amazon: {
          pb: "https://www.amazon.com/dp/B0FPF71CQ8"
        },
...
`
  ...
  sudoku: {
    ...
    books: {
      s1: {
        ...
        img: {
          sm: "assets/covers/sudoku-1.jpg",
          lg: "assets/covers/sudoku-1-lg.jpg"
        },
      ...
      s2: {
        ...
        img: {
          sm: "assets/covers/sudoku-2.jpg",
          lg: "assets/covers/sudoku-2-lg.jpg"
        },
      ...
      s3: {
        ...
        img: {
          sm: "assets/covers/sudoku-3.jpg",
          lg: "assets/covers/sudoku-3-lg.jpg"
        },
      ...
      s4: {
        ...
        img: {
          sm: "assets/covers/sudoku-4.jpg",
          lg: "assets/covers/sudoku-4-lg.jpg"
        },
  ...
  // Заглушки — можно заполнить позже
...
// Элементы интерфейса (ожидаются в index.html/dad.html/…)
const el = {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Делегирование кликов по карточкам (Preview & Buy)
  ...
  // Поддержка авто-открытия со страниц /dad.html и т.п. (если их скрипт так вызовет)
  // Пример: setTimeout(() => openModal('journals','dad'), 80) — уже есть в дочерних страницах.
});
...
function renderSeries(seriesKey) {
  ...
  // Выбираем «первоочередную» книгу для hero (если есть)
  const firstBookId = Object.keys(series.books || {})[0];
  ...
  // track (по желанию)
  // if (window.ttq) ttq.track('ViewSeries', { series: seriesKey });
}

// Обновляет ссылки CTA (hero, sticky, strip) под указанную книгу
...
function renderBookCard(seriesKey, id, book) {
  return `
    <article class="book" data-series="${seriesKey}" data-book="${id}">
      <img src="${book.img?.sm || ""}" alt="${escapeHtml(book.title)}" loading="lazy">
      <div>
...
function openModal(seriesKey, bookId) {
  ...
  if (el.mThumbs) {
    el.mThumbs.innerHTML = (book.pages || [])
      .map((src) => `<img src="${src}" alt="Preview page" loading="lazy">`)
      .join("");
  }
